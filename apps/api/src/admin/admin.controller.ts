import { Controller, Get, Post, Put, Patch, Delete, Body, Param, Query, UseGuards, UsePipes, ParseIntPipe, DefaultValuePipe, UseInterceptors, UploadedFile } from '@nestjs/common';
...
export class AdminController {
  ...
  async createProduct(@Body() data: Record<string, unknown>) {
  ...
  async createCategory(@Body() data: Record<string, unknown>) {
  ...
  async updateCategory(@Param('id') id: string, @Body() data: Record<string, unknown>) {
  ...
  async createUpsellConfig(@Body() data: Record<string, unknown>) {
  ...
  async updateUpsellConfig(@Param('id') id: string, @Body() data: Record<string, unknown>) {
  ...
  async createBundleConfig(@Body() data: Record<string, unknown>) {
  ...
  async updateBundleConfig(@Param('id') id: string, @Body() data: Record<string, unknown>) {
  ...
  async createPromoConfig(@Body() data: Record<string, unknown>) {
  ...
  async updatePromoConfig(@Param('id') id: string, @Body() data: Record<string, unknown>) {
  ...
  async updateSiteConfig(@Param('id') id: string, @Body() data: Record<string, unknown>) {
  ...
  async updateOrderStatus(
    ...
    return this.adminService.updateOrderStatus(id, dto.status as OrderStatus, dto.note);
  }
  ...
  async createVariant(
    @Param('id') id: string,
    @Body() data: { name: string; priceAdjustment: number },
  ) {
    return this.adminService.createVariant(id, data);
  }
  ...
  async updateVariant(
    ...
    @Body() data: { name?: string; priceAdjustment?: number; isActive?: boolean },
  ) {
    return this.adminService.updateVariant(variantId, data);
  }
  ...
  @ApiOperation({ summary: 'Get product addons' })
  async getProductAddons(@Param('id') id: string) {
    return this.adminService.getProductAddons(id);
  }

  @Post('products/:id/addons')
  @ApiOperation({ summary: 'Create product addon' })
  async createAddon(
    @Param('id') id: string,
    @Body() data: { name: string; price: number; maxQuantity?: number },
  ) {
    return this.adminService.createAddon(id, data);
  }

  @Put('products/:id/addons/:addonId')
  @ApiOperation({ summary: 'Update product addon' })
  async updateAddon(
    @Param('addonId') addonId: string,
    @Body() data: { name?: string; price?: number; maxQuantity?: number; isActive?: boolean },
  ) {
    return this.adminService.updateAddon(addonId, data);
  }

  @Delete('products/:id/addons/:addonId')
  @ApiOperation({ summary: 'Delete product addon' })
  async deleteAddon(@Param('addonId') addonId: string) {
    return this.adminService.deleteAddon(addonId);
  }
