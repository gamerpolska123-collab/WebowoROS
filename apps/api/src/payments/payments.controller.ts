...
import { UserRole, Order } from '@prisma/client';
...
const SimulatePaymentSchema = z.object({
  ...
  method: z.enum(['cash_on_delivery', 'card_on_delivery']).optional(),
});
...
export class SimulatePaymentDtoClass {
  ...
  @ApiPropertyOptional({ example: 'cash_on_delivery', enum: ['cash_on_delivery', 'card_on_delivery'], description: 'Payment method override' })
  method!: string;
}
...
export class PaymentStatusResponseDto {
  ...
  @ApiProperty({ example: 'cash_on_delivery', enum: ['cash_on_delivery', 'card_on_delivery'] })
