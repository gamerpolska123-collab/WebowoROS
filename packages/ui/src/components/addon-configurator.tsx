    ...
    <div className={cn('space-y-4', className)}>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-primary font-semibold">+{addon.price.toFixed(2)} zł</p>
                </div>
              </div>
      ...
      <div className="border-t pt-4">
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-xl font-bold text-primary tabular-nums">{totalPrice.toFixed(2)} zł</span>
        </div>
        <Button
          className="w-full"
